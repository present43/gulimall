...
import com.liuz.gulimall.store.service.PurchaseService;
...
public class PurchaseController {
    ...
    // @RequiresPermissions("store:purchase:info")
     ...
     */
    @RequestMapping("/save")
    // @RequiresPermissions("store:purchase:save")
    ...
    // @RequiresPermissions("store:purchase:update")
    ...
    // @RequiresPermissions("store:purchase:delete")
